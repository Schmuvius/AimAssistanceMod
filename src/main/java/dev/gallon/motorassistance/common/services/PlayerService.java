...
public class PlayerService extends EntityService {
    ...
    // Renamed from findMobsAroundPlayer to findPlayersAroundPlayer
    public List<EntityService> findPlayersAroundPlayer(double range) {
        return entity
                .level()
                .getEntitiesOfClass(
                        Player.class,
                        ...
                        player -> player != entity // Exclude the current player
                )
                .stream()
